        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-7 col-md-offset-2">
                    <form action="{{ route('book.postEdit') }}" class="form form-horizontal" method="POST">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="published_date" class="form-control" value="{{ $book->published_date }}">
